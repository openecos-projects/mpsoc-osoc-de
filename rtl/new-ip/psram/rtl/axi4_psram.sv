...
`ifdef __VERILOG__
    `apb4_slave_if(apb4),
    `axi4_slave_if(axi4),
    output psram_psram_sck_o,
    output psram_psram_ce_o,
    output psram_psram_io_en_o,
    input  psram_psram_io_in_i,
    output psram_psram_io_out_o,
    output psram_psram_dqs_en_o,
    input  psram_psram_dqs_in_i,
    output psram_psram_dqs_out_o,
    output psram_irq_o
`else
    apb4_if.slave apb4,
    axi4_if.slave axi4,
...
`ifndef __VERILOG__
  ...
  `axi4_slave_if2wire(axi4, axi4);
  logic psram_psram_sck_o;
  logic psram_psram_ce_o;
  logic psram_psram_io_en_o;
  logic psram_psram_io_out_o;
  logic psram_psram_dqs_en_o;
  logic psram_psram_dqs_out_o;
  logic psram_irq_o;
  assign psram.psram_sck_o     = psram_psram_sck_o;
  assign psram.psram_ce_o      = psram_psram_ce_o;
  assign psram.psram_io_en_o   = psram_psram_io_en_o;
  assign psram.psram_io_out_o  = psram_psram_io_out_o;
  assign psram.psram_dqs_en_o  = psram_psram_dqs_en_o;
  assign psram.psram_dqs_out_o = psram_psram_dqs_out_o;
  assign psram.irq_o           = psram_irq_o;
`endif
