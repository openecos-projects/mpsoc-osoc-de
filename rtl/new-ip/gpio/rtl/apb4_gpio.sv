...
`ifdef __VERILOG__
    `apb4_slave_if(apb4),
    input  [`GPIO_PIN_NUM-1:0] gpio_gpio_in_i,
    output [`GPIO_PIN_NUM-1:0] gpio_gpio_out_o,
    output [`GPIO_PIN_NUM-1:0] gpio_gpio_dir_o,
    output [`GPIO_PIN_NUM-1:0] gpio_gpio_alt_in_o,
    input  [`GPIO_PIN_NUM-1:0] gpio_gpio_alt_0_out_i,
    input  [`GPIO_PIN_NUM-1:0] gpio_gpio_alt_0_dir_i,
    input  [`GPIO_PIN_NUM-1:0] gpio_gpio_alt_1_out_i,
    input  [`GPIO_PIN_NUM-1:0] gpio_gpio_alt_1_dir_i,
    output                     gpio_irq_o
`else
    apb4_if.slave apb4,
    gpio_if.dut   gpio
...
`ifndef __VERILOG__
  ...
  wire [`GPIO_PIN_NUM-1:0] gpio_gpio_in_i        = gpio.gpio_in_i;
  wire [`GPIO_PIN_NUM-1:0] gpio_gpio_alt_0_out_i = gpio.gpio_alt_0_out_i;
  wire [`GPIO_PIN_NUM-1:0] gpio_gpio_alt_0_dir_i = gpio.gpio_alt_0_dir_i;
  wire [`GPIO_PIN_NUM-1:0] gpio_gpio_alt_1_out_i = gpio.gpio_alt_1_out_i;
  wire [`GPIO_PIN_NUM-1:0] gpio_gpio_alt_1_dir_i = gpio.gpio_alt_1_dir_i;
  wire [`GPIO_PIN_NUM-1:0] gpio_gpio_out_o;
  wire [`GPIO_PIN_NUM-1:0] gpio_gpio_dir_o;
  wire [`GPIO_PIN_NUM-1:0] gpio_gpio_alt_in_o;
  wire                     gpio_irq_o;

  assign gpio.gpio_out_o    = gpio_gpio_out_o;
  assign gpio.gpio_dir_o    = gpio_gpio_dir_o;
  assign gpio.gpio_alt_in_o = gpio_gpio_alt_in_o;
  assign gpio.irq_o         = gpio_irq_o;
`endif
  ...
  assign s_gpio_dir_d  = apb4_pwdata[`GPIO_PIN_NUM-1:0];
  ...
  assign s_gpio_out_d  = apb4_pwdata[`GPIO_PIN_NUM-1:0];
  ...
  assign s_gpio_inten_d  = apb4_pwdata[`GPIO_PIN_NUM-1:0];
  ...
  assign s_gpio_inttype0_d  = apb4_pwdata[`GPIO_PIN_NUM-1:0];
  ...
  assign s_gpio_inttype1_d  = apb4_pwdata[`GPIO_PIN_NUM-1:0];
  ...
  assign s_gpio_iofcfg_d  = apb4_pwdata[`GPIO_PIN_NUM-1:0];
  ...
  assign s_gpio_pinmux_d  = apb4_pwdata[`GPIO_PIN_NUM-1:0];
  ...
  always_comb begin
    ...
    if (s_apb4_rd_hdshk) begin
      unique case (s_apb4_addr)
        `GPIO_PADDIR:   apb4_prdata[`GPIO_PIN_NUM-1:0] = s_gpio_dir_q;
        `GPIO_PADIN:    apb4_prdata[`GPIO_PIN_NUM-1:0] = s_gpio_in;
        `GPIO_PADOUT:   apb4_prdata[`GPIO_PIN_NUM-1:0] = s_gpio_out_q;
        `GPIO_INTEN:    apb4_prdata[`GPIO_PIN_NUM-1:0] = s_gpio_inten_q;
        `GPIO_INTTYPE0: apb4_prdata[`GPIO_PIN_NUM-1:0] = s_gpio_inttype0_q;
        `GPIO_INTTYPE1: apb4_prdata[`GPIO_PIN_NUM-1:0] = s_gpio_inttype1_q;
        `GPIO_INTSTAT:  apb4_prdata[`GPIO_PIN_NUM-1:0] = s_gpio_intstat_q;
        `GPIO_IOFCFG:   apb4_prdata[`GPIO_PIN_NUM-1:0] = s_gpio_iofcfg_q;
        `GPIO_PINMUX:   apb4_prdata[`GPIO_PIN_NUM-1:0] = s_gpio_pinmux_q;
        default:        apb4_prdata[`GPIO_PIN_NUM-1:0] = '0;
      endcase
    end
  end
  ...
  for (genvar i = 0; i < `GPIO_PIN_NUM; i++) begin : ALT_PINMUX_BLOCK
    assign s_gpio_alt_dir[i] = s_gpio_pinmux_q[i] ? gpio_gpio_alt_1_dir_i[i] : gpio_gpio_alt_0_dir_i[i];
    assign s_gpio_alt_out[i] = s_gpio_pinmux_q[i] ? gpio_gpio_alt_1_out_i[i] : gpio_gpio_alt_0_out_i[i];
  end

  for (genvar i = 0; i < `GPIO_PIN_NUM; i++) begin : IOF_PINMUX_BLOCK
    assign gpio_gpio_dir_o[i]    = s_gpio_iofcfg_q[i] ? s_gpio_alt_dir[i] : s_gpio_dir_q[i];
    assign gpio_gpio_out_o[i]    = s_gpio_iofcfg_q[i] ? s_gpio_alt_out[i] : s_gpio_out_q[i];
    assign gpio_gpio_alt_in_o[i] = s_gpio_iofcfg_q[i] ? gpio_gpio_in_i[i] : '0;
  end
